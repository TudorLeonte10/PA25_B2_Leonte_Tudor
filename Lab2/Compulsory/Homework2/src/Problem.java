        ...
        for (int i = 0; i < students.length; i++) {
            for (int j = i + 1; j < students.length; j++) {
                if (students[i].equals(students[j])) {
                    throw new IllegalArgumentException("Exista deja un student cu registrationNumber " + students[i].getRegNumber());
                }
            }
        }
        ...
        for (int i = 0; i < teachers.length; i++) {
            for (int j = i + 1; j < teachers.length; j++) {
                if (teachers[i].equals(teachers[j])) {
                    throw new IllegalArgumentException("Exista deja un profesor cu aceleași date.");
                }
            }
        }
        ...
        for (int i = 0; i < projects.length; i++) {
            for (int j = i + 1; j < projects.length; j++) {
                if (projects[i].equals(projects[j])) {
                    throw new IllegalArgumentException("Exista deja un proiect cu acelasi titlu si tip.");
                }
            }
        }
